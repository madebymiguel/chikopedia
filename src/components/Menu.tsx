...
export default function Menu() {
    ...
    return(
        <div className="menu-container">
            ...
            <div ref={dropdownRef} className={`menu-contents ${menu ? 'active' : 'inactive'}`}>
                <form id="scroll-grid" onChange={(e) => onChangeStyle}>
                   
                    <label className="radio-label">  
                        <input className="radio-button" type="radio" id="scroll" name="style" value="scroll" checked />
                        Scroll
                    </label>
                    <label className="radio-label">
                        <input className="radio-button" type="radio" id="grid" name="style" value="grid" />
                        Grid
                    </label>
                </form>
                <div id="livingdex-switch">
                    <Switch className="toggle-switch" onChange={handleSwitchChange} checked={livingdex} />
